...
todoItems.MapGet("/search/priority/{priority}", SearchByPriority);

static async Task<IResult> SearchByPriority(string priority, TodoDb db)
{
...
static async Task<IResult> UpdateTodo(int id, TodoItemDTO todoItemDTO, TodoDb db)
{
    ...
    todo.Status = todoItemDTO.Status;
